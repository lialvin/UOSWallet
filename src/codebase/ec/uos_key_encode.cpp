...
std::vector<unsigned char> uos_key::get_public_key_by_pri(const std::vector<unsigned char>& pri)
{
...
std::string uos_key::get_uos_public_key_by_wif(const std::string& wif)
{
    std::string uos_pub;
...
std::vector<unsigned char> uos_key::get_private_key_by_wif(const std::string &wif)
{
    std::vector<unsigned char> result;
    if (wif.empty()) {
        return result;
...
std::vector<unsigned char> uos_key::get_public_key_char(const std::string &uoskey){
    std::string epk = uoskey.substr(3,-1);
...
std::vector<unsigned char> uos_key::get_public_key_by_uos_pub(const std::string &pub)
{
    std::vector<unsigned char> base = uos_key::get_public_key_char(pub);
    unsigned char pk[64];
